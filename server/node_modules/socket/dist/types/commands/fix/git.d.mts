export declare function getBaseGitBranch(): string;
export declare function getSocketBranchName(purl: string, newVersion: string, workspaceName?: string | undefined): string;
export declare function getSocketPrTitlePattern(purl: string, workspaceName?: string | undefined): RegExp;
